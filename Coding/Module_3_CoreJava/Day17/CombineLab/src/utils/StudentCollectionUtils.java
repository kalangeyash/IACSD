	...
	private static int index = 0;
	 ...
	 public static List<Student> populateList() {
		List<Student> students = new ArrayList<>(
				Arrays.asList(
						new Student("dac-001", "ravi", parse("1999-12-13"), ANGULAR, 9.2),
						...
						new Student("dac-022", "sameer", parse("1990-12-06"), JAVA, 8.2)));
					
		
		List<Address> adrs = Arrays.asList(
				new Address("pune", "MH", "452446"), 
